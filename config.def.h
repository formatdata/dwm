...
static const char *brightup[] = { "/usr/bin/brightnessctl", "s", "+1", NULL };
static const char *brightdown[] = { "/usr/bin/brightnessctl", "s", "1-", NULL };
static const char *ss[] 	= { "/usr/bin/scrot", "-t", "20", "-d", "5", NULL };
